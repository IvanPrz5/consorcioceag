                    ...
                    <template v-slot:default="dialog">
                        <v-card>
                            ...
                            <!-- NUEVA -->
                                ...
                                <CrearOrganigrama  :cerrarDialogo = dialog  @Guardado = "Guardado"   ></CrearOrganigrama>
                ...
                <template v-slot:default="dialog">
                    <v-card>
                        ...
                        <br>
                          ...
                          <EditarOrganigrama  :cerrarDialogo = dialog    :organigramaEditar="item" @Guardado = "Guardado"   ></EditarOrganigrama>
...
export default {
    ...
    methods: {
        ...
        borrar() {
            ...
            axios.delete('/api/organigrama/borrar/' + this.seleccionado.id)
                .then(response => {
