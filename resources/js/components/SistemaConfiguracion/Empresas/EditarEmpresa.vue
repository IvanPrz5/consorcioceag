...
export default {
    props: ["empresaOriginal", "cerrarDialogo"],
    data: () => ({
    ...
    methods: {
        NuevaEmpresa() {
            if (this.$refs.form.validate()) {
                ...
                data.append('id', this.empresa.id);
                ...
                data.append('cer', this.empresa.cer);
                data.append('key', this.empresa.key);
                ...
                axios.post('/api/Empresa/editar', data)
                    .then(response => {
