...
<v-form ref="form" enctype="multipart/form-data">
    ...
    <v-container>
        ...
        <v-btn color="ceagAzul" @click="Editar">
            Guardar
        </v-btn>
...
export default {
    props: ["cerrarDialogo", "menuEntrada"],
    data: () => ({
        menu: {
                id:'',
                descripcion: '',
    ...
    created(){
        ...
        this.sistemas();
        this.menu.id = this.menuEntrada.id ;
        this.menu.descripcion = this.menuEntrada.descripcion ;
        this.menu.icono = this.menuEntrada.icono ;
        this.menu.ruta = this.menuEntrada.ruta ;
        this.menu.estatus = this.menuEntrada.estatus ;
        this.menu.id_sistema = this.menuEntrada.id_sistema;

        this.sistemaBuscar =  this.menuEntrada.sistema_nombre;
    ...
    methods: {
        Editar() {
            if (this.$refs.form.validate()) {
                ...
                axios.post('/api/menu/editar', this.menu)
                    .then(response => {
