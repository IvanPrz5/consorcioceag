...
<div>
   ...
   <crearMenu  :cerrarDialogo = "dialog"   @Guardado = "Guardado" ></crearMenu>
                ...
                <template v-slot:default="dialog">
                    <v-card>
                        ...
                        <br>
                          ...
                          <EditarMenu  :cerrarDialogo = dialog    :menuEntrada="item" @Guardado = "Guardado"   ></EditarMenu>
